...
const common = {
  ...
  ketesa: {
    auth: {
      base_url: "Otthoni Szerver URL",
      welcome: "Üdv %{name}",
      description:
        "A Synapse Admin továbbfejlesztése. Kezelj, felügyelj, és tartsd karban a Matrix otthoni szervered egy tisza felületről. Kis, privát szervereknek és nagy, szétotsztott közösségeknek egyaránt.",
      server_version: "Synapse verzió",
      supports_specs: "Támogatott Matrix specifikációk",
      username_error: "Kérlek adj meg egy teljes, érvényes felhasználó azonosítót: '@felhasználónév:domain'",
      protocol_error: "Az URL-nek 'http://'-vel vagy 'https://'-el kell kezdődnie",
      url_error: "Érvénytelen Matrix szerver URL",
      sso_sign_in: "Bejelentkezés SSO-val",
      credentials: "Hitelesítő adatok",
      access_token: "Hozzáférési token",
      logout_access_token_dialog: {
        title: "Egy meglévő Matrix hozzáférési tokent használsz.",
        content:
          "Meg akarod szűntetni a munkamenetet (amit máshol is használhatsz, pl. egy Matrix kliensben), vagy csak ki szeretnél jelentkezni az admin felületről?",
        confirm: "Munkamenet megszüntetése",
        cancel: "Csak kijelentkezés az admin felületről",
      },
    },
    users: {
      invalid_user_id: "Csak a Matrix azonosítód felhasználónevét add meg — ne tartalmazza az otthoni szerver domaint.",
      tabs: {
        sso: "SSO",
        experimental: "Kísérleti",
        limits: "Korlátozások",
        account_data: "Fiók Adatok",
        sessions: "Munkamenetek",
      },
      danger_zone: "Veszélyzóna",
    },
    rooms: {
      details: "Szoba részletei",
      tabs: {
        basic: "Alapok",
        members: "Tagok",
        detail: "Részletek",
        permission: "Engedélyek",
        media: "Média",
        messages: "Üzenetek",
        hierarchy: "Hierarchia",
      },
    },
    reports: { tabs: { basic: "Alapok", detail: "Részletek" } },
    admin_config: {
      soft_failed_events: "Nem kritikus hiba események",
      spam_flagged_events: "Spamként megjelölt események",
      success: "Adminisztrátori beállítások frissítve",
      failure: "Hiba történt az adminisztrátori beállítások frissítése során",
    },
  },
  import_users: {
    error: {
